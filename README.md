...
![](http://oweupqzdv.bkt.clouddn.com/QQ%E6%88%AA%E5%9B%BE20171112203638.jpg "登录界面")
...
- 修改各依赖相应IP配置(默认本地127.0.0.1)，以及七牛云、极验配置在 `xmall-common - utils` 中找到修改
...
- 后端管理系统端口8888 http://localhost:8888 管理员账密admin|123456
- 前端项目接口端口7777
### 技术疑问交流
