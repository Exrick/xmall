...
<div class="page-container">
    <form name="product-add" action="" method="post" class="form form-horizontal" id="product-add">
        ...
        <input type="text" name="picUrl2" id="picUrl2" hidden/>
        <input type="text" name="picUrl3" id="picUrl3" hidden/>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>3D轮播图图片上传：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <div class="uploader-list-container">
                    <div class="queueList">
                        <div id="dndArea" class="placeholder">
                            ...
                            <p>或将照片拖到这里，最多可选3张</p>
                            <p style="color: tomato">若不配置3D轮播图，上传一张主图即可</p>
                        </div>
                    </div>
    ...
    (function ($) {
        ...
        $(function () {
            ...
            uploader = WebUploader.create({
                ...
                fileNumLimit: 3,
                fileSizeLimit: 3 * 5 * 1024 * 1024,    // 15 M
            ...
            uploader.on( 'uploadSuccess', function( file,data ) {
                if(data.success==true){
                    ...
                    if(pic1!=""&&pic2==""&&pic3==""){
                        $("#picUrl2").val(data.result);
                    }
                    if(pic1!=""&&pic2!=""&&pic3==""){
                        $("#picUrl3").val(data.result);
                    }
                }else{
