...
<div class="page-container">
    <form class="form form-horizontal" id="picture-edit">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>超链接：</label>
...
<script type="text/javascript">
    ...
    $("#link").val(parent.link);

    //保存发布
    $("#picture-edit").validate({
        rules:{
            link:{
                required:true,
            },
